            ...
            # apply identifier
                ...
                # retain the value while in the middle
                    ...
                    if ( vehicle_id != 0) :
                        ...
                        end_point = (block_end-thickness_min_horizontal, height_end)    # for thighter bounding box
                        label_point= (block_start+10, height_end-20)
                        cv2.rectangle(image_display, start_point, end_point, (255,36,12), LINE_THICKNESS) # blue
                        cv2.putText(image_display, str(vehicle_id), label_point, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,36, 12), LINE_THICKNESS-1)
                    ...
                    if ( vehicle_id != 0) :
                        ...
                        cv2.rectangle(image_display, start_point, end_point, (12,36,255), LINE_THICKNESS) # red
                        cv2.putText(image_display, str(vehicle_id), label_point, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (12,36, 255), LINE_THICKNESS-1)
